    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-success">
      <div className="container-fluid">
        ...
        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          <span className="navbar-toggler-icon"><img src="%PUBLIC_URL%/favicon.png" /></span>
        </button>
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className='nav-item dropdown'>
              <a className='nav-link active dropdown-toggle' href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Inventory</a>
            ...
            <li className='nav-item dropdown'>
              <a className='nav-link active dropdown-toggle' href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Auto Sales</a>
              <ul className='dropdown-menu'>
            ...
            <li className='nav-item dropdown'>
              <a className='nav-link active dropdown-toggle' href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Auto Service</a>
              <ul className='dropdown-menu'>
            ...
            <li className="nav-item active">
              <div className="nav-link active" aria-current="page" to="/login">Welcome</div>
            </li>
            <li className="nav-item">
